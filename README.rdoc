...
Step 1. Регистрируем свое прилоение в instagram
				Регистрируем приложение в инстаграме: http://instagram.com/developer/
        Незабываем снять галочку с чекбокса "Disable implicit OAuth". 
